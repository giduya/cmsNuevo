$(document).ready(function(){
    ...
    $("#faqForm").on("submit",function(){
        ...
        if(keyword.length >= 3){
            ...
            $("#faqSearchResult").html("<span class='text-success'>Encontrados en "+items.length+" respuestas</span>");
        }else
            $("#faqSearchResult").html("<span class='text-error'>3 caracteres mínimos necesarios</span>");
