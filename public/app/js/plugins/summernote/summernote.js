...
(function (factory) {
    ...
    lang: {
      'en-US': {
        ...
        image: {
          ...
          resizeFull: 'Redimencionar al 100%',
          resizeHalf: 'Redimensionar al 50%',
          resizeQuarter: 'Redimencionar al 25%',
          floatLeft: 'Alinear Izquierda',
          floatRight: 'Alinear Derecha',
          floatNone: 'Sin Alinear',
          dragImageHere: 'Arrastra tu imagen aquií',
        ...
        link: {
          link: 'Link',
          insert: '<i class="far fa-link"></i> Insertar hipervínculo',
          unlink: 'Quitar hipervínculo',
          edit: 'Editar',
          textToDisplay: 'Texto a mostrar',
          url: '<p>Link al que deseas ir:</p>',
  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      ...
      link: function (lang) {
        return tplIconButton('far fa-link icon-link', {
      ...
      table: function (lang) {
        var dropdown = '<ul class="dropdown-menu">' +
                       ...
                       '</ul>';
        return tplIconButton('far fa-table icon-table', {
      ...
      style: function (lang, options) {
        ...
        return tplIconButton('far fa-magic icon-magic', {
      ...
      bold: function (lang) {
        return tplIconButton('far fa-bold icon-bold', {
          event: 'bold',
          title: lang.font.bold
        });
      },
      italic: function (lang) {
        return tplIconButton('far fa-italic icon-italic', {
          event: 'italic',
          title: lang.font.italic
        });
      },
      underline: function (lang) {
        return tplIconButton('far fa-underline icon-underline', {
          event: 'underline',
      ...
      clear: function (lang) {
        return tplIconButton('far fa-eraser icon-eraser', {
          event: 'removeFormat',
          title: lang.font.clear
        });
      },
      ul: function (lang) {
        return tplIconButton('far fa-list-ul icon-list-ul', {
          event: 'insertUnorderedList',
          title: lang.lists.unordered
        });
      },
      ol: function (lang) {
        return tplIconButton('far fa-list-ol icon-list-ol', {
          event: 'insertOrderedList',
          title: lang.lists.ordered
        });
      },
      paragraph: function (lang) {
        var leftButton = tplIconButton('far fa-align-left icon-align-left', {
          title: lang.paragraph.left,
          event: 'justifyLeft'
        });
        var centerButton = tplIconButton('far fa-align-center icon-align-center', {
          title: lang.paragraph.center,
          event: 'justifyCenter'
        });
        var rightButton = tplIconButton('far fa-align-right icon-align-right', {
          title: lang.paragraph.right,
          event: 'justifyRight'
        });
        var justifyButton = tplIconButton('far fa-align-justify icon-align-justify', {
          title: lang.paragraph.justify,
          event: 'justifyFull'
        });

        var outdentButton = tplIconButton('far fa-outdent icon-indent-left', {
          title: lang.paragraph.outdent,
          event: 'outdent'
        });
        var indentButton = tplIconButton('far fa-indent icon-indent-right', {
        ...
        return tplIconButton('far fa-align-left icon-align-left', {
      ...
      fullscreen: function (lang) {
        return tplIconButton('far fa-arrows-alt icon-fullscreen', {
          event: 'fullscreen',
      ...
      undo: function (lang) {
        return tplIconButton('far fa-undo icon-undo', {
          event: 'undo',
          title: lang.history.undo
        });
      },
      redo: function (lang) {
        return tplIconButton('far fa-redo icon-repeat', {
          event: 'redo',
    ...
    var tplPopovers = function (lang, options) {
      ...
      var tplImagePopover = function () {
        ...
        var removeButton = tplIconButton('far fa-trash-alt icon-trash', {
    ...
    var tplDialogs = function (lang, options) {
      ...
      var tplLinkDialog = function () {
        var body = '<div class="form-group">' +
                     '<label class="control-label" for="link1">' + lang.link.textToDisplay + '</label>' +
                     '<input id="link1" class="note-link-text form-control span12" type="text" /><br/>' +
                   '</div><br/>' +
                   '<div class="form-group">' +
                     '<label class="control-label" for="link2">' + lang.link.url + '</label>' +
                     '<input id="link2" class="note-link-url form-control span12" type="text" /><br/>' +
                   '</div>' +
        ...
        var footer = '<button href="#" class="btn btn-info note-link-btn disabled" disabled>' + lang.link.insert + '</button>';
      ...
      var tplVideoDialog = function () {
        var body = '<div class="form-group">' +
                   ...
                   '</div>';
        var footer = '<button href="#" class="btn btn-info note-video-btn disabled" disabled>' + lang.video.insert + '</button>';
